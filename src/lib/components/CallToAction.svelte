	...
	<section>
		...
		<div class="mx-auto px-2 md:px-12 xl:px-32">
			<div class="text-center">
				...
				>
					<h1
						class="drop-shadow-lg mb-10 xs:text-xl sm:text-3xl md:text-3xl xl:text-5xl lg:text-center font-bold tracking-tight"
					>
						Gute Dinge brauchen Planung
					</h1>
					<p class="text-black text-base xs:text-sm md:text-md">
