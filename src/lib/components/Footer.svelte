		...
		<div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
			<div class="sm:col-span-2">
				<a href="/" aria-label="Go home" title="FM-Felgentechnik" class="inline-flex items-center">
					<h4 class="text-md font-extrabold text-white drop-shadow-sm">FM-Felgentechnik</h4>
				</a>
			...
			<div>
				...
				<div class="flex xs:justify-center md:justify-start mt-1 space-x-3">
					<a
						href="https://www.instagram.com/fm_felgentechnik"
						class="text-white drop-shadow-sm"
						alt="Instagram"
					>
						<svg
					...
					<a
						href="https://www.facebook.com/people/FM-Felgentechnik/61564548587452/?mibextid=LQQJ4d&rdid=AbQrnAaErmpvcYtV"
						class="text-white drop-shadow-sm"
						alt="Facebook"
					>
						<svg
